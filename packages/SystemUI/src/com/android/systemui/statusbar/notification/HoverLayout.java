...
public class HoverLayout extends RelativeLayout implements ExpandHelper.Callback, SwipeHelper.Callback {
	...
	public HoverLayout(Context context, AttributeSet attrs) {
        ...
        int maxHeight = mContext.getResources().getDimensionPixelSize(R.dimen.default_notification_row_max_height);		mExpandHelper = new ExpandHelper(mContext, this, minHeight, maxHeight);
